...
// Şimdilik soru ağacını bu dosyanın içine gömüyoruz.
// Dosya yolu sorunlarını tamamen devre dışı bırakmak için.
...
const treeJson = {
  ...
  nodes: [
    ...
    },
    {
      ...
      weight: 1.2,
      mediaType: "image",
      mediaUrl: "/assets/images/blurred-crowd-1.jpg", // İstersen sonra gerçek görselle değiştir
    ...
    },
    {
      ...
      weight: 0.8,
      mediaType: "text",
      text: "Genel olarak duyusal uyaranlar seni ne çok yoruyor ne de özellikle heyecanlandırmıyor.",
      next: [
        { range: [-2, 2], nextId: "q_end_main" }
      ]
    },
...
export function getNextNodeId(currentNode, answerValue) {
